...
const ServicesGetAnswerSchema = [
  ...
  },
  {
    ...
    gridSize: "6",
    sectionName: Sections.CenterDetails,
    options: [{ value: "01", label: { ar: "ذوي الإعاقة" } }],
    validators: [],
  },
  {
    id: uuid(),
  ...
  },
  {
    ...
    name: "targetedGender",
    attrFunc: (value) =>
      value === "m" ? "ذكر" : value === "f" ? "انثى" : "كلا الجنسين",
    type: "Text",
    gridSize: "6",
    sectionName: Sections.CenterDetails,
    options: [],
...

  {
    ...
    options: [
      { value: 1, label: { ar: "رخصة وزارة الصحة", en: "MOH License" } },
      {
        value: 2,
        label: {
          ar: "عقد شراكة مع منشأة رعاية صحية",
          en: "Partnership contract with a Health Care Facility",
        },
      },
    ],
    dependOn: {
...
export default ServicesGetAnswerSchema;
